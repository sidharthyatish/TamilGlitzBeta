...
public class VideoSongs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_video_songs, container, false);
    }
    @Override
    ...
    */
    ...
    private void getData(int page){
        ...
        String url="https://tamilglitz.in/api/get_category_posts/?id=947&count=2&page=";

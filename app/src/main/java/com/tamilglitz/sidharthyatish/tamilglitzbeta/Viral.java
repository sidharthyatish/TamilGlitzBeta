...
public class Viral extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_viral, container, false);
    }
    @Override
    ...
    */
    ...
    private void getData(int page){
        ...
        String url="https://tamilglitz.in/api/get_category_posts/?id=813&count=2&page=";

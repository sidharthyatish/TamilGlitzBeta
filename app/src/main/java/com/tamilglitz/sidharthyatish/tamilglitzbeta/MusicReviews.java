...
public class MusicReviews extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_music_reviews, container, false);
    }
    ...
    private void getData(final int page){
        ...
        String url="https://tamilglitz.in/api/get_category_posts/?slug=music-reviews&count=2&page=";
